...
const posts_url = "http://localhost/cmsAPI/api/posts.php";
const users_url = "http://localhost/cmsAPI/api/users.php";
const groups_url = "http://localhost/cmsAPI/api/groups.php";
const comments_url = "http://localhost/cmsAPI/api/comments.php";
...
async function fetchAdminData() {
    try {
      const response = await fetch('http://localhost/cmsAPI/api/users.php?user_id=' + user_id, {
          method: "GET",
          headers: {
